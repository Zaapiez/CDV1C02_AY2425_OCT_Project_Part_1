...
<caption><h2>Add product</h2>
</caption>
<br>
<br>
<label>Product Name :</label><input type="text" class="form-control" name="prodname">
</fieldset>
<fieldset class="form-group">
<label>Quantity : </label><input type="text" class="form-control" name="prodquantity">
</fieldset>
